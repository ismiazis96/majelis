...
class M_pengguna extends CI_Model{
	...
	function simpan_pengguna($nama,$jenkel,$username,$password,$email,$nohp,$level,$gambar){
		$hsl=$this->db->query("INSERT INTO tbl_pengguna (pengguna_nama,pengguna_jenkel,pengguna_username,pengguna_password,pengguna_email,pengguna_nohp,pengguna_level,pengguna_photo,pengguna_status) VALUES ('$nama','$jenkel','$username',md5('$password'),'$email','$nohp','$level','$gambar','1')");
		return $hsl;
	}

	function simpan_pengguna_tanpa_gambar($nama,$jenkel,$username,$password,$email,$nohp,$level){
		$hsl=$this->db->query("INSERT INTO tbl_pengguna (pengguna_nama,pengguna_jenkel,pengguna_username,pengguna_password,pengguna_email,pengguna_nohp,pengguna_level,pengguna_status) VALUES ('$nama','$jenkel','$username',md5('$password'),'$email','$nohp','$level','1')");
		return $hsl;
	}
	...
	function update_status($id){
		$hsl = $this->db->query("UPDATE tbl_pengguna SET pengguna_status='0' WHERE pengguna_id='$id'");
		return $hsl;
	}

	function update_status_aktif($id){
		$hsl = $this->db->query("UPDATE tbl_pengguna SET pengguna_status='1' WHERE pengguna_id='$id'");
		return $hsl;
	}
